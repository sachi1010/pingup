                ...
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={handlesaveprofile}>
                        ...
                        <div className='flex justify-end space-x-3 pt-6'>
                            <button className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'
                             onClick={()=>setShowEdit(false)} type='button' >Cancel</button>
