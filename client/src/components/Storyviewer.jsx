...
const Storyviewer = ({viewStory,setViewStory}) => {
    ...
    const rendercontent = ()=>{
        switch (viewStory.media_type) {
            case 'image':
                 return(
                    <img src={viewStory.media_url} alt={viewStory.title} className='max-w-full max-h-screen object-contain'/>
                 );
             case 'video':
                 return(
                    <video src={viewStory.media_url} alt={viewStory.title} className=' max-h-screen' onEnded={()=>setViewStory(null)}controls autoplay/>
                 );    
            case 'text':
                 return(
