      ...
      <div className='max-w-6xl mx-auto p-6'>
       ...
       <div className='max-w-xl bg-white p-4 sm:p-8 rounded-xl shadow-md space-y-4'>
          ...
          images.length>0 && <div className='flex flex-wrap gap-2 mt-4'>
            {images.map((image,i)=>(
              <div key={i} className='relative group'>
                 ...
                 <div className='absolute hidden group-hover:flex justify-center items-center top-0 right-0 bottom-0 left-0
                 bg-black/40 rounded-md cursor-pointer' onClick={()=>setImages(images.filter((_,index)=> index !== i))}>
        ...
        <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
          ...
          <button disabled={loading} onClick={()=>toast.promise(handlesubmit(),{loading:"uploading...",
            success:<p>Post Added</p>,error:<p>Post Not Added</p>
